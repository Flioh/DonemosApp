...
import { ResumenSolicitudModel } from './resumen-solicitud';

/* Modelos usados en los tests */
import { SolicitudModel } from '../solicitud/solicitud';
import { CiudadModel } from '../ciudad/ciudad';
import { ProvinciaModel } from '../provincia/provincia';
import { FactorSanguineoModel } from '../factor-sanguineo/factor-sanguineo';
import { GrupoSanguineoModel } from '../grupo-sanguineo/grupo-sanguineo';
...
import { FactorSanguineoEnum, GrupoSanguineoEnum } from '../../providers/donaciones/donaciones';
